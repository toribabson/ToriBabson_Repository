...
ggplot(intercepts, aes(x=intercept_val, y=log_likelihood)) +
  geom_point() +
  stat_smooth() +
  geom_hline(aes(yintercept = -1251.602), color = "red") +
  geom_hline(aes(yintercept = -1250.342), color = "forestgreen") +
  labs(title = "Intercept Likelihood Profile", x="Intercept Values", y="Log Likelihood")
...
ggplot(slopes, aes(x=slope_vals, y=log_likelihood)) +
  ...
  geom_hline(aes(yintercept = -1250.342), color = "forestgreen") +
  theme_light() +
  labs(title = "Slope Likelihood Pofile", x = "Slope Values", y = "Log Likelihood")

# CI VALUES
# Loglik value for 95% CI is -1251.602
# Loglik value for 75% CI is -1250.119
